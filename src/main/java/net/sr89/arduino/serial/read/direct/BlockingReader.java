...
public class BlockingReader implements Closeable {

    private static final Duration MAX_TIMEOUT = Duration.ofMillis(Integer.MAX_VALUE);

    private final SerialPort comPort;

    public BlockingReader(SerialPort comPort, Duration timeout) throws IllegalArgumentException {
        ...
        comPort.setComPortTimeouts(TIMEOUT_READ_BLOCKING, (int) timeout.toMillis(), 0);
    }
